...
```{r}
BB_hex <- st_read("C:/Users/Administrator/Documents/data/kontur_population_BB_20231101.gpkg") %>% st_transform(3106)
BB_admin <- st_read("C:/Users/Administrator/Documents/data/kontur_boundaries_BB_20230628.gpkg") %>% st_transform(3106)
```
...
```{r}
 library(ggplot2)
ggplot(BB_hex) + 
  geom_sf(aes(fill = population), color = "blue", linewidth = 0) + 
  geom_sf(data = BB_boundary, fill = NA, color = "white")
```

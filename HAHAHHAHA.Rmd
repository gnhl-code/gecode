...
```{r}
IT_hex <- st_read("C:/Program Files/RStudio/data/kontur_population_IT_20231101.gpkg") %>% st_transform(3106)
IT_admin <- st_read("C:/Program Files/RStudio/data/kontur_boundaries_IT_20230628.gpkg") %>% st_transform(3106)
```

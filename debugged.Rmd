...
```{r}
outfile <- glue::glue("C:/Program Files/RStudio/data/SI_final_2.png")
...
# Read the SVG image
pop_raster <- image_read("C:/Program Files/RStudio/data/SI_final_2.png")
...
pop_raster %>%
  ...
  image_annotate("Visualization by | Culanggo, Felisilda, Casiño, Abainza \nData | Kontur Population 2023",
                 ...
                 size = 22,
                 degrees = 0) %>%
  image_write("C:/Program Files/RStudio/data/SI_final_2.png", format = "png", quality = 100)
```
